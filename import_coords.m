function coords = import_coords(filename, startRow, endRow)
%IMPORTFILE4 Import numeric data from a text file as a matrix.
%   COORDS = IMPORTFILE4(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   COORDS = IMPORTFILE4(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   coords = importfile4('coords.txt', 1, 524146);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/02/26 12:03:44
